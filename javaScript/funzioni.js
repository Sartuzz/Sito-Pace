...
function teamChanger(i)
{
    switch(i)
    {
        ...
        case 5: return "<img class='imm_team' src='../img/team/garzoni.png'><div id='testo_team'><h2 class='Nome_team'>Garzoni Stefano</h2><span class='sottotitolo_team'>Studente</span><p class='descrizione_team'>La migliore specie di amico è quel tipo con cui puoi stare seduto in un portico e camminarci insieme, senza dire una parola, e quando vai via ti senti come se fosse stata la migliore conversazione della tua vita. - È veramente buono battersi con persuasione, abbracciare la vita e vivere con passione, perdere con classe e vincere osando, perchè il mondo appartiene a chi osa! La Vita è troppo bella per essere insignificante!</p><div class='social_team'><a href='https://www.instagram.com/stefanogarzonii/' target='_blank'><img class='logo_social' src='../img/instagram.svg'> <span>: @stefanogarzonii</span></a></div></div>";
                break;
