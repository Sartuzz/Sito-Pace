...
function teamChanger(i)
{
    switch(i)
    {
        ...
        case 2: return "<img class='imm_team' src='../img/team/taiola.jpg'><div id='testo_team'><h2 class='Nome_team'>Taiola Federico</h2><span class='sottotitolo_team'>Studente</span><p class='descrizione_team'>Federico Taiola, studente, iscritto al 5° anno d'indirizzo Informatico presso l'Istituto Perlasca di Vobarno;<br>grande appassionato di pallacanestro, pratica basket fin da bambino e attualmente milita nell'impegnativo campionato agonistico di serie D con la divisa del New Basket Prevalle.<br>Professionista capace di inserirsi in realtà molto differenziate, caratterizzate da rapide evoluzioni sia dal punto di vista tecnologico che da quello dell'organizzazione del lavoro, trova la sua collocazione sia nelle imprese specializzate nella produzione di software, sia nelle ditte che trattano i sistemi d’elaborazione dati, indipendentemente dall'ambito di applicazione.<br>Grande appassionato di musica, quando non lavora è impegnato nel mondo del volontariato no-profit.</p><div class='social_team'><a href='https://www.instagram.com/fede_taiola/' target='_blank'><img class='logo_social' src='../img/instagram.svg'> <span>: @fede_taiola</span></a></div></div>";
                break;
                
        case 3: return "<img class='imm_team' src='../img/team/tonolini.png'><div id='testo_team'><h2 class='Nome_team'>Tonolini Elena</h2><span class='sottotitolo_team'>Studente</span><p class='descrizione_team'>La vispa Teresa avea tra l'erbetta, a volo sorpresa gentil farfalletta. E tutta giuliva stringendola viva gridava a distesa: 'L'ho presa! L'ho presa!'. A lei supplicando l'afflitta gridò: 'Vivendo, volando che male ti fò? Tu sì mi fai male stringendomi l'ale! Deh, lasciami! Anch'io son figlia di Dio!'. Teresa pentita allenta le dita: 'Va', torna all'erbetta, gentil farfalletta.</p><div class='social_team'><a href='https://www.instagram.com/elena_tonolinii/' target='_blank'><img class='logo_social' src='../img/instagram.svg'> <span>: @elena_tonolinii</span></a></div></div>";
                break;
